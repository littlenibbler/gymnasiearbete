...
func_Template = [
    ...
    [PCO|MRI,  RAO|IRI|PCE,  RAO|ARI|PCE,    SKP,         SKP,         SKP, SKP, SKP],     # 00001 - LDI #
    [PCO|MRI,  RAO|IRI|PCE,  RAO|BRI|PCE,    ALO|ARI,     SKP,         SKP, SKP, SKP],     # 00010 - ADI #
    [PCO|MRI,  RAO|IRI|PCE,  RAO|BRI|PCE,    ALO|ARI|SUB, SKP,         SKP, SKP, SKP],     # 00011 - SUI #
    [PCO|MRI,  RAO|IRI|PCE,  RAO|MRI|PCE,    RAI|ARO,     SKP,         SKP, SKP, SKP],     # 00100 - STA abs
    ...
    [PCO|MRI,  RAO|IRI|PCE,  RAO|MRI|PCE,    RAO|ARI,     SKP,         SKP, SKP, SKP],     # 01001 - LDA abs
    [PCO|MRI,  RAO|IRI|PCE,  RAO|MRI|PCE,    RAO|BRI,     ALO|ARI,     SKP, SKP, SKP],     # 01010 - ADD abs
    [PCO|MRI,  RAO|IRI|PCE,  RAO|MRI|PCE,    RAO|BRI,     ALO|ARI|SUB, SKP, SKP, SKP],     # 01011 - SUB abs
...
with open("Compiled.txt", "w") as file:
    for address in range(2**10):
        if address % 8 == 0 and address != 0:
            file.write("\n")

        flags = address >> 8
        instruction = (address & 0b0011111000) >> 3
